...
class Ui_PasswordDialog(object):
    def setupUi(self, PasswordDialog):
        ...
        self.label_3 = QtGui.QLabel(PasswordDialog)
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_3.setFont(font)
        self.label_3.setText(QtGui.QApplication.translate("PasswordDialog", "/etc/init.d/apache stop", None, QtGui.QApplication.UnicodeUTF8))
