...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.gridLayout.addWidget(self.pollingIntervalSpinbox, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sleepTimeSpinbox, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.themeComboBox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.suppressStdoutCheckBox, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.kNotifyCheckBox, 5, 1, 1, 1)
        ...
        self.iconStyleComboBox = QtGui.QComboBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.iconStyleComboBox.setFont(font)
        self.iconStyleComboBox.setObjectName(_fromUtf8("iconStyleComboBox"))
        self.iconStyleComboBox.addItem(_fromUtf8(""))
        self.iconStyleComboBox.addItem(_fromUtf8(""))
        self.iconStyleComboBox.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.iconStyleComboBox, 3, 1, 1, 1)
        ...
        self.panelBehaviorComboBox = QtGui.QComboBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.panelBehaviorComboBox.setFont(font)
        self.panelBehaviorComboBox.setObjectName(_fromUtf8("panelBehaviorComboBox"))
        self.panelBehaviorComboBox.addItem(_fromUtf8(""))
        self.panelBehaviorComboBox.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.panelBehaviorComboBox, 0, 1, 1, 1)
        ...
        Settings.setTabOrder(self.panelBehaviorComboBox, self.pollingIntervalSpinbox)
        Settings.setTabOrder(self.pollingIntervalSpinbox, self.sleepTimeSpinbox)
        Settings.setTabOrder(self.sleepTimeSpinbox, self.iconStyleComboBox)
        Settings.setTabOrder(self.iconStyleComboBox, self.themeComboBox)
        Settings.setTabOrder(self.themeComboBox, self.kNotifyCheckBox)
        Settings.setTabOrder(self.kNotifyCheckBox, self.suppressStdoutCheckBox)
...
"if you experience annoying error output being produced by some commands.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.iconStyleComboBox.setItemText(0, QtGui.QApplication.translate("Settings", "only state indicators", None, QtGui.QApplication.UnicodeUTF8))
        self.iconStyleComboBox.setItemText(1, QtGui.QApplication.translate("Settings", "only icons", None, QtGui.QApplication.UnicodeUTF8))
        self.iconStyleComboBox.setItemText(2, QtGui.QApplication.translate("Settings", "combined", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("Settings", "Service icon style:", None, QtGui.QApplication.UnicodeUTF8))
        self.panelBehaviorComboBox.setItemText(0, QtGui.QApplication.translate("Settings", "display icons directly inside the panel", None, QtGui.QApplication.UnicodeUTF8))
        self.panelBehaviorComboBox.setItemText(1, QtGui.QApplication.translate("Settings", "display service list in a popup window", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("Settings", "Behavior when put into panel:", None, QtGui.QApplication.UnicodeUTF8))
