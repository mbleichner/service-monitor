...
"If the status immediatly flashes back to inactive when starting a service, increase this value.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox.setItemText(0, QtGui.QApplication.translate("Settings", "Remember forever", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.setItemText(1, QtGui.QApplication.translate("Settings", "Remember for session", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.setItemText(2, QtGui.QApplication.translate("Settings", "Remember for fixed time", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.setItemText(3, QtGui.QApplication.translate("Settings", "Do not remember", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.spinBox.setSuffix(QtGui.QApplication.translate("Settings", " min", None, QtGui.QApplication.UnicodeUTF8))
